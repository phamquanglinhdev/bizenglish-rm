...
<head>
    ...
    <link rel="stylesheet" href="{{asset("vendor/css/rtl/theme-bordered.css")}}" class="template-customizer-theme-css"/>
          ...
          <g id="icon" transform="translate(0.000000, 4.000000)">
            ...
            <rect id="Rectangle" fill="url(#linearGradient-2)" x="0" y="0" width="7.68181818"
                  height="7.68181818"></rect>
                            ...
                            <span class="app-brand-text demo h3 mb-0 fw-bold text-uppercase">Bizenglish</span>
                        </a>
                    </div>
                    <!-- /Logo -->
...
<!-- Mirrored from demos.pixinvent.com/frest-html-admin-template/html/vertical-menu-template-bordered/auth-login-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 23:13:46 GMT -->
</html>
