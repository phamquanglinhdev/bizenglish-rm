...
class LogListObject
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'students' => DataBroTable::cView("belongToMany", ['entry' => 'students', 'objects' => $this->getStudents()]),
            'clients' => DataBroTable::cView("belongToMany", ['entry' => 'students', 'objects' => $this->getClients()]),
